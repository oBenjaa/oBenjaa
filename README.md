...
[![My Skills](https://skillicons.dev/icons?i=js,ts,python,lua,html,css,react,nodejs,electron,tailwind,mongodb,github,git,vscode)](https://skillicons.dev)


### Gostaria de aprender:
[![Future](https://skillicons.dev/icons?i=java,kotlin,cs,rust,neovim,spring,mysql,docker,ps,ae,aws,linux)](https://skillicons.dev)
<div>
